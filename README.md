...
The refactoring plan and design documentation live in [`docs/REFACTORING.md`](docs/REFACTORING.md). API reference is generated by `go doc` from source comments. Upstream Sphinx/rst docs have not been fully migrated yet — see `docs/REFACTORING.md` §7.
